...
const Payment = () => {
  ...
  const isFormValid = () => {
    ...
    return !hasErrors && selectedPaymentMethod.category && selectedPaymentMethod.method;
  };
    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-100 py-4 sm:py-6 mx-4">
      <div className="w-full max-w-[85rem] flex flex-col lg:flex-row lg:h-[45rem]">
        ...
        <div className="w-full lg:w-2/3 flex flex-col items-center gap-4 mr-2 sm:gap-6 py-6 sm:py-8">
          ...
          <div className="bg-[#738FFD] rounded-lg shadow-lg w-full max-w-[50rem] px-4 sm:px-6 py-6 sm:p-8 text-white">
            <h2 className="text-lg sm:text-xl font-bold mb-3 -mt-3">Customer Detail</h2>
            <form className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              ...
              <div className="flex flex-col">
                ...
                <input
                  ...
                  className="mt-1 sm:mt-2 p-2 rounded-lg text-black text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-blue-500"
          ...
          <div className="bg-[#738FFD] rounded-lg shadow-lg w-full max-w-[50rem] px-4 sm:px-6 py-4 sm:p-5 text-white">
            <div className="flex justify-between text-sm sm:text-lg font-medium">
              <span>Price</span>
              <span>Rp{formattedPrice}</span>
            </div>
            <div className="flex justify-between text-sm sm:text-lg font-medium mb-2">
              <span>Service Fee</span>
              <span>Rp{taxPrice}</span>
            </div>
            <div className="flex justify-between text-sm sm:text-lg font-bold border-t border-white pt-2">
              <span>Total</span>
              <span>Rp{totalPrice}</span>
            </div>
          </div>
          {/* Reset Button */}
          <div className="w-full max-w-[50rem] px-4 sm:px-6 mt-4 sm:mt-6 hidden lg:block">
            <button
              type="button"
              onClick={handleReset}
        ...
        <div className="w-full lg:w-1/3 flex flex-col items-center gap-4 sm:gap-6 py-6 sm:py-8">
          <div className="w-full lg:max-w-[25rem] px-4 sm:px-6 text-start">
            <p className="text-base sm:text-lg font-semibold">
          ...
          <div className="w-full lg:max-w-[25rem] bg-[#738FFD] rounded-lg shadow-lg w-full px-4 sm:px-6 py-4 sm:p-6 h-auto sm:h-[31rem] sm:text-base">
            <h2 className="text-base sm:text-lg font-bold text-white mb-3 sm:mb-4">
              Select Payment Option
            </h2>
            <div className="flex flex-col gap-4 sm:gap-6">
              <div className="bg-[#E6FDA3] p-1 rounded-lg">
                <span className="block text-black font-semibold pl-2 text-sm sm:text-base">
                  Virtual Account
                </span>
              </div>
              <div className="flex flex-wrap gap-3 sm:gap-4">
                <img
                  ...
                  alt="BCA"
                  className={`w-10 sm:w-12 h-10 sm:h-12 object-contain bg-white rounded-md p-2 cursor-pointer ${
                    selectedPaymentMethod.method === "BCA" && "ring-2 ring-blue-500"
                  }`}
                ...
                <img
                  ...
                  alt="BNI"
                  className={`w-10 sm:w-12 h-10 sm:h-12 object-contain bg-white rounded-md p-2 cursor-pointer ${
                    selectedPaymentMethod.method === "BNI" && "ring-2 ring-blue-500"
                  }`}
                ...
                <img
                  ...
                  alt="Mandiri"
                  className={`w-10 sm:w-12 h-10 sm:h-12 object-contain bg-white rounded-md p-2 cursor-pointer ${
                    selectedPaymentMethod.method === "Mandiri" && "ring-2 ring-blue-500"
                  }`}
                ...
                <img
                  ...
                  alt="BRI"
                  className={`w-10 sm:w-12 h-10 sm:h-12 object-contain bg-white rounded-md p-2 cursor-pointer ${
                    selectedPaymentMethod.method === "BRI" && "ring-2 ring-blue-500"
                  }`}
                ...
                <img
                  ...
                  alt="BSI"
                  className={`w-10 sm:w-12 h-10 sm:h-12 object-contain bg-white rounded-md p-2 cursor-pointer ${
                    selectedPaymentMethod.method === "BSI" && "ring-2 ring-blue-500"
                  }`}
              ...
              <div className="flex flex-wrap gap-3 sm:gap-4">
                <img
                  ...
                  alt="Gopay"
                  className={`w-10 sm:w-12 h-10 sm:h-12 object-contain bg-white rounded-md p-2 cursor-pointer ${
                    selectedPaymentMethod.method === "Gopay" && "ring-2 ring-blue-500"
                  }`}
                ...
                <img
                  ...
                  alt="Ovo"
                  className={`w-10 sm:w-12 h-10 sm:h-12 object-contain bg-white rounded-md p-2 cursor-pointer ${
                    selectedPaymentMethod.method === "Ovo" && "ring-2 ring-blue-500"
                  }`}
                ...
                <img
                  ...
                  alt="ShopeePay"
                  className={`w-10 sm:w-12 h-10 sm:h-12 object-contain bg-white rounded-md p-2 cursor-pointer ${
                    selectedPaymentMethod.method === "ShopeePay" && "ring-2 ring-blue-500"
                  }`}
              ...
              <div className="flex flex-wrap gap-3 sm:gap-4">
                <img
                  ...
                  alt="Visa"
                  className={`w-10 sm:w-12 h-10 sm:h-12 object-contain bg-white rounded-md p-2 cursor-pointer ${
                    selectedPaymentMethod.method === "Visa" && "ring-2 ring-blue-500"
                  }`}
                ...
                <img
                  ...
                  alt="MasterCard"
                  className={`w-10 sm:w-12 h-10 sm:h-12 object-contain bg-white rounded-md p-2 cursor-pointer ${
                    selectedPaymentMethod.method === "MasterCard" && "ring-2 ring-blue-500"
                  }`}
          ...
          <div className="w-full max-w-[50rem] px-4 sm:px-6 mt-4 sm:mt-6 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            {/* Reset Button */}
            <button
              type="button"
              onClick={handleReset}
              className="block lg:hidden w-full sm:w-auto px-4 sm:px-6 py-2 sm:py-3 bg-[#E6FDA3] text-black font-semibold rounded-lg shadow-md hover:bg-[#F2FA5A] transition text-sm sm:text-base"
            >
              Reset
            </button>
            ...
            <button
              type="button"
              onClick={handleNext}
              className={`ml-auto w-full sm:w-auto px-4 sm:px-6 py-2 sm:py-3 font-semibold rounded-lg shadow-md transition text-sm sm:text-base ${
                isFormValid()
